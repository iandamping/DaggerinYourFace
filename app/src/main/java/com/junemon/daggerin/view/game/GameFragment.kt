...
import com.junemon.daggerin.presentation.Constant.gamesDiffCallbacks
...
class GameFragment : BaseFragment() {
    ...
    private fun ActivityMainBinding.consumeData(result: List<com.junemon.daggerin.presentation.model.GamePresentation>?) {
        recyclerHelper.run {
