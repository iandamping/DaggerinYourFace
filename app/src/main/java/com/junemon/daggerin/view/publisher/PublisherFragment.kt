...
import com.junemon.daggerin.presentation.base.BaseFragment
import com.junemon.daggerin.domain.model.ResultToConsume
import com.junemon.daggerin.databinding.ActivityPublisherBinding
import com.junemon.daggerin.presentation.Constant.publisherDiffCallbacks
...
class PublisherFragment : BaseFragment() {
    ...
    private fun ActivityPublisherBinding.consumeData(result: List<com.junemon.daggerin.presentation.model.PublisherPresentation>?) {
        recyclerHelper.run {
